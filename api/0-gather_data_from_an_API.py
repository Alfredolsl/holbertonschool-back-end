...
employee_id = argv[1]
employee = requests.get(f"https://jsonplaceholder.typicode.com/users?id={employee_id}").json()
employee_name = employee[0]["name"]

todo_list = requests.get(f"https://jsonplaceholder.typicode.com/todos?userId={employee_id}").json()
